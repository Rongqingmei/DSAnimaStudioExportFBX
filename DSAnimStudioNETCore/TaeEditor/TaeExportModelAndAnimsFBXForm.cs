...
{
    public partial class TaeExportModelAndAnimsFBXForm : Form
    {
        ...
        public TaeExportModelAndAnimsFBXForm()
        {
            InitializeComponent();
        }
        ...
        private void TaeExportModelAndAnimsFBXForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (IS_BUSY)
            {
                e.Cancel = true;
        ...
        private void buttonStartExport_Click(object sender, EventArgs e)
        {
            ...
            Task.Run(new Action(() =>
            {
                ...
                {
                    var exporter = new ToolExportModelAndAnimsToFBX();
                    ...
                    // 执行生成模型
                    exporter.ExportFBXModel();

                    bool userRequestCancelSkeleton = false; // test
                    /* ----------------------------------------  Export Skeleton ----------------------------------------*/
